...
Welcome to the backend component of `ecommerce-microservice`. This Java based backend is designed to handle the
...
```bash
   git clone https://github.com/satya042/Ecommerce-backend.git
```
